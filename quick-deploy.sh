...
# Quick deployment script for Vismaya DemandOps
# Run this on your EC2 instance

set -e

echo "🚀 Quick deploying Vismaya DemandOps..."
...
echo "🌐 Your application should be available at: http://$(curl -s http://169.254.169.254/latest/meta-data/public-ipv4):8503"
